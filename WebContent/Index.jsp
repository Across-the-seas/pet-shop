...
<header>
    <div class="soubg">
        ...
        <div class="fr top_right">
            <div class="fl">
                你好! 请<a href="loadpage.html">登录</a>
        ...
        <div class="i_car">
            ...
            <div class="last">
                ...
                <div class="shop">
                    ...
                    <div class="buy">
                        <p>合计 <span class="J_totalPrice">￥953.8</span></p>
        ...
        <div class="banner">
            <div class="top_slide_wrap">
                <ul class="slide_box ">
                    ...
                    <li><img src="images/ban2.jpg" width="700" height="401"/></li>
                    <li><img src="images/ban3.jpg" width="700" height="401"/></li>
                </ul>
                <ul class="num">
...
<footer class="center">
    ...
    <!--Footer -->
      ...
      <div class="f"> <img id="sss" src="images/ssw1.jpg" ></div>
   <div class="s"><img  id="ok "src="images/ok.jpg" ></div>
   <div class="ts"><img id="cancle" src="images/cancle.jpg" ></div>
